						...
						child: Column(
							...
							children: [
								...
								Row(
									...
									children: [
										const Text('لديك حساب بالفعل؟ ', style: TextStyle(color: GameOnColors.textSecondary)),
										InkWell(
											onTap: () => context.go('/login'),
											child: const Text('تسجيل الدخول', style: TextStyle(color: GameOnColors.primaryGreen)),
										),
									],
								),
								const SizedBox(height: 12),
